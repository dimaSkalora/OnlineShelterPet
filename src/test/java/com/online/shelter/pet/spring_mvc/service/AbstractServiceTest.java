...
import static com.online.shelter.pet.spring_mvc.util.ValidationUtil.getRootCause;
...
@Sql(scripts = "classpath:servlet/db/populateDB.sql", config = @SqlConfig(encoding = "UTF-8"))
