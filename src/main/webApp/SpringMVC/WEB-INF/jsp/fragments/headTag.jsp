...
<head>
    ...
    <link rel="shortcut icon" href="resources/images/icon-pet.png">
    ...
    <%--    <script type="text/javascript" src="webjars/datetimepicker/2.5.1/build/jquery.datetimepicker.full.min.js" defer></script>--%>
