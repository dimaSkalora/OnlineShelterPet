...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <a href="pets" class="navbar-brand"><spring:message code="app.title"/></a>
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <sec:authorize access="isAuthenticated()">
                        <form:form class="navbar-form" action="logout" method="post">
                            <a class="btn btn-info" href="petsAllUsers"><spring:message code="user.petsAllUsers"/></a>
                            <%--<a class="btn btn-info" href="myPets"><spring:message code="user.pets"/></a>--%>
