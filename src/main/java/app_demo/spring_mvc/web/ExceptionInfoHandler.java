...
import app_demo.spring_mvc.util.exception.ErrorInfo;
...
import static app_demo.spring_mvc.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_DUPLICATE_DATETIME = "exception.pet.duplicateDateTime";
            ...
            new HashMap<String, String>() {
                {
                    ...
                    put("pets_unique_user_datetime_idx", EXCEPTION_DUPLICATE_DATETIME);
                }
            });
