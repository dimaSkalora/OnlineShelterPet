...
public class PetUtil {
    ...
    public static List<PetWithDownplayWeight> getWithDownplayWeight(List<Pet> pets, double normalWeight){
        return getFilteredWithDownplayWeight(pets,Arrays.asList("Cat","Dog",""),normalWeight);
    }
